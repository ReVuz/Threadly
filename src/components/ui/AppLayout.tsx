...
function HomeIcon({ size = 18, active }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={active ? "var(--primary)" : "currentColor"} strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
...
function WishlistIcon({ size = 18, active }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill={active ? "var(--accent-light)" : "none"} stroke={active ? "var(--accent)" : "currentColor"} strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
